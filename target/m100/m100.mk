...
M100ZCCOPTS := +m100 -subtype=default -m -pragma-define:CLIB_EXIT_STACK_SIZE=0
...
m100/%.ihx : m100/%.co
	...
	z88dk-appmake +hex --binfile $< --org 49994 --output $@

m100/hw.co : hw.c | m100

	zcc $(M100ZCCOPTS)  -pragma-define:CLIB_EXIT_STACK_SIZE=0 \
		-create-app -m -o $@ $<
